function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-['Agency_FB']">
      ...
      <div className="w-1/2">
        <h1 className="text-[8vw] font-['Agency_FB'] font-semibold uppercase leading-none -mb-5">
          Presentation
        </h1>
        <div className="details font-['Agency_FB'] mt-10">
          {["Facebook", "Instagram", "Twitter"].map((item, index) => (
            <span key={index} className="block">
              <a key={index} href="#" className="text-xl font-light">
                {item}
              </a>
            </span>
          ))}
